...
const navbar = () => {
  return (
    <nav className="relative w-full">
        <div className="z-20 w-[90vw] mt-auto my-3 rounded-full h-16 bg-[#1a1a1a]/20 backdrop-blur-md  border border-[#676363] flex flex-col items-center  fixed left-1/2 -translate-x-1/2 top-5 md:shadow-[0_4px_0_0_rgba(166,209,47,0.4)]" id="manv">
            <div className=" h-16 flex items-center justify-between pl-3 w-full  top-0 rounded-full px-5">
                ...
                <div className="flex items-center gap-10 text-md max-[623px]:gap-2 ">
                    ...
                    <i
                        className="fa-solid fa-bars nav text-[#776e6e] text-2xl pl-4 hidden! max-[702px]:block! active:text-[#cfff45] transition-all duration-100"></i>
                </div>

                <button
                    className="discoverbtn font-bold w-29 h-8  cursor-pointer rounded-lg bg-neutral-100 p-3 text-neutral-500 shadow-[0_4px_0_0_rgba(0,0,0,0.15)] transition-all duration-200 hover:translate-y-[2px] hover:shadow-[0_2px_0_0_rgba(0,0,0,0.15)] active:translate-y-[4px] active:shadow-none sm:p-[10px] dark:bg-[#cfff45] dark:text-[#131313] dark:shadow-[0_4px_0_0_#a1c13d] dark:hover:shadow-[0_2px_0_0_#a1c13d] dark:active:shadow-none hidden md:block relative">
                    <span className="absolute left-2 top-1.5">Discover</span><span
                        className="discovericon absolute left-20 top-2 hidden"><i
